...
public class UserDutyRoasterTest extends BaseTest {
    ...
    @Test(priority = 2, dependsOnMethods = "testUserLogin", description = "Verify user can navigate to Duty Roster page")
    ...
    @Test(priority = 3) // , dependsOnMethods = "testOpenDutyRoasterSection", description = "Test
                        // monthly calendar view of duty roster")
    ...
    @Test(priority = 4, dependsOnMethods = "testMonthlyDutyRoasterCalendarView", description = "Test monthly table view of duty roster")
