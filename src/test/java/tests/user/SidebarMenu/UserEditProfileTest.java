...
public class UserEditProfileTest extends BaseTest {
    ...
    @Test(priority = 2, dependsOnMethods = "testUserLogin", description = "Verify user can navigate to Edit Profile page")
    ...
    @Test(priority = 4) // , dependsOnMethods = "testUpdateGuardianName",description = "Update all
                        // mandatory fields")
    ...
    @Test(priority = 5, dependsOnMethods = "testUpdateProfileWithAllMandatoryFields", description = "Verify user can logout successfully after editing the profile")
