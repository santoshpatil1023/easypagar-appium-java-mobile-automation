...
//    public void testAdminCanCreateBanner() throws IOException, InterruptedException {
//        adminDashboard.clickBanners();
//        adminBannersPage = new AdminBannersPage(driver);
//        Assert.assertTrue(adminBannersPage.isBannersPageDisplayed(),
...
//    @Test(priority = 3)
//    public void testCreateBannerWithDifferentImage() throws IOException, InterruptedException {
//        adminDashboard.clickBanners();
//        adminBannersPage = new AdminBannersPage(driver);
//        
//        adminBannersPage.clickComposeButton();
