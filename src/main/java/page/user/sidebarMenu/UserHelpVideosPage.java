...
public class UserHelpVideosPage {
    ...
    private By attendanceVideos = AppiumBy
            .xpath("//android.widget.TextView[@text='Employee-How to Mark  Attendance.']");
    ...
    private By reportVideos = AppiumBy
            .xpath("//android.widget.TextView[@text='Reports -How to Check Different Reports']");
