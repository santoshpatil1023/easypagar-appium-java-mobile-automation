...
public class UserEditProfilePage {
    ...
    private By saveConfermationMsg = AppiumBy.xpath("//android.widget.TextView[@resource-id='com.pagarplus.app:id/snackbar_text']");
...
//	    String yearDropDown = "new UiSelector().resourceId(\"android:id/date_picker_header_year\")";
//	    testUtils.clickWhenClickable(AppiumBy.androidUIAutomator(yearDropDown), 10);
//	    String select2000year = "new UiSelector().text(\"" + year + "\")";
//	    testUtils.clickWhenClickable(AppiumBy.androidUIAutomator(select2000year), 10);
//	}
...
//	            WebElement yearElement = driver.findElement(AppiumBy.androidUIAutomator(yearSelector));
//	            yearElement.click();
//	            yearFound = true;
//	            break;
//	        } catch (Exception e) {
...
//	    
//	    if (!yearFound) {
//	        throw new RuntimeException("Could not find year " + year + " after " + maxScrolls + " scrolls");
//	    }
//	}
//
	...
	private void scrollToYearSimple(String targetYear) {
	    ...
	    while (scrollCount < maxScrollAttempts) {
	        try {
	            ...
	            WebElement yearElement = driver.findElement(By.xpath("//android.widget.TextView[@text='" + targetYear + "']"));
