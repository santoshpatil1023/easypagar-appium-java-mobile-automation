...
public class UserApplyLoanAdvancePage {
    ...
    private By loanApplied = AppiumBy
            .androidUIAutomator("new UiSelector().text(\"Loan Request Created Successfully\")");
    private By advanceApplied = AppiumBy
            .androidUIAutomator("new UiSelector().text(\"Advance Request Created Successfully\")");
