...
public class UserMyAttendancePage {
    ...
    // Locators
    private By locationAllowButtonLocator = AppiumBy
    ...
    private By cameraShutter2 = AppiumBy.xpath(
            "//android.widget.FrameLayout[@resource-id=\"android:id/content\"]/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[12]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup");
    private By cameraShutter = AppiumBy.xpath(
    ...
    private By checkOutPopupMessage1 = AppiumBy
            .xpath("//android.widget.TextView[@text='Your Trying To  Leave Early , Please Contact Your  Manager']");
    private By checkOutPopupMessage2 = AppiumBy
            .xpath("  //android.widget.TextView[@text='Organization appreciates your extra efforts. Good work!']");
    ...
    private By checkInTimeDynamic = AppiumBy.xpath(
    ...
    public boolean isCheckInWithinFiveMinutes() {
        try {
            ...
            // Extract time part for simplicity (you might need to adjust based on actual
            // format)
