...
public class UserMessagePage {
    ...
    private By messageSearchBarLocator = AppiumBy
            .xpath("//android.widget.EditText[@resource-id='text-input-outlined']");
    ...
    public void clickOnFirstMessage() {
        ...
        if (utils.isElementPresent(noDataFoundLocator, 5)) {
            ...
            // Assert.assertTrue(true, "'No Data Found' displayed - expected scenario,
            // marking test as PASS.");
    ...
    private By[] sendButtonLocators = {
            ...
            AppiumBy.xpath(
                    "//android.widget.EditText[@text='Write a Message']/following-sibling::android.view.ViewGroup"),
