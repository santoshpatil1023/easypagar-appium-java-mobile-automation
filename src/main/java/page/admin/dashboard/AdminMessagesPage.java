...
//    private By branchDropdown = AppiumBy.xpath("//android.widget.TextView[@text=\"Select Branch *\"]");
...
//        utils.clickWhenClickable(AppiumBy.androidUIAutomator("new UiSelector().text('"+empName+"')"), 10);
    ...
    private By clickPhoto = AppiumBy.androidUIAutomator("new UiSelector().className(\"android.view.ViewGroup\").instance(34)");
