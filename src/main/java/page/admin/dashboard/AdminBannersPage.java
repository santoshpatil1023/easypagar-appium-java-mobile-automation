...
public class AdminBannersPage {
	...
	// AppiumBy.xpath("//android.view.ViewGroup[@resource-id='fab-content']");
	...
	// private By clickPhoto = AppiumBy.androidUIAutomator("new
	// UiSelector().className(\"android.view.ViewGroup\").instance(40)");
	private By clickPhoto = AppiumBy
			.androidUIAutomator("new UiSelector().className(\"android.view.ViewGroup\").instance(39)");
	...
	private By firstImage = AppiumBy.xpath(
			"//android.support.v7.widget.RecyclerView[@resource-id='com.android.documentsui:id/dir_list']/android.widget.LinearLayout[1]/android.widget.LinearLayout");
	...
	public void createBanner(String branch, String department, String title, String description, String imageFileName)
